    ...
    this.each(function () {
      ...
      var interval = setInterval(function () {
        ...
        if (position == indexOf) {
          ...
          $this.delay(defaults.speed).find('span').html(changer.substring(0, position - indexOf) + $bintext.substring(position, ($bintext.length)));

        } else if (position < indexOf) {

          $bintext = bintext($text.length - 1);

          $this.delay(defaults.speed).html(normal.substring(0, position) + $bintext.substring(position, ($bintext.length)));
        ...
        if (position < $text.length) {
          ...
          setInterval(function () {
            ...
            var changeInterval = setInterval(function () {
              ...
              $this.delay(defaults.speed).find('span').html(newText.substring(0, position) + $bintext.substring(position, ($bintext.length)));
